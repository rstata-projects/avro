...
public class TestGenericDatumReader {
  ...
  public TestGenericDatumReader(String description, Schema writerSchema, Schema readerSchema,
                                Object input, Object expectedOutput) {
  ...
  static {
    testData = new Object[][]{
      // Identical reader and writer schemas
        ...
        {"plain map<string, int>", "{\"type\": \"map\", \"values\": \"int\"}", "{\"type\": \"map\", \"values\": \"int\"}",
...
//      FIXME: Enum is not handled yet
      ...
      {"string to bytes", "{\"type\": \"string\"}", "{\"type\": \"bytes\"}", "a10", ByteBuffer.wrap(new byte[]{'a', '1', '0'})},
      {"bytes to string", "{\"type\": \"bytes\"}", "{\"type\": \"string\"}", ByteBuffer.wrap(new byte[]{'a', '1', '0'}), "a10"},
      ...
      {"union<int, string> to union<long, string, boolean>", "[\"int\", \"string\"]", "[\"long\", \"string\", \"boolean\"]", "s", "s"},
      {"union<long, string, boolean> to union<int, string>", "[\"long\", \"string\", \"boolean\"]", "[\"int\", \"string\"]", "s", "s"},
    };
  }
}
